...
Locator: locator('.main-text-error, [class*="text"] .error, mat-error').filter({ hasText: /minimum.*20|20.*minimum|63.?206/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.main-text-error, [class*="text"] .error, mat-error').filter({ hasText: /minimum.*20|20.*minimum|63.?206/i })
