...
- Name: TC-07.spec.ts >> TC-07 | Create News Form - Cancel Button and Confirmation Modal >> should close the form and redirect to news page when "Yes, cancel" is selected
- Location: tests\TC-07.spec.ts:6:7
